...
class TrustCare_Model_FrmCareAdhIntervention extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCareAdhIntervention
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCareAdhIntervention($options);
    ...
    public static function replaceForFrmCare($id_frm_care, array $dictIds, array $options = null)
    {
        ...
        $model = new TrustCare_Model_FrmCareAdhIntervention($options);

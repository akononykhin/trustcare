...
class TrustCare_Model_FacilityLevel extends TrustCare_Model_Abstract
{
    protected $_id;
    protected $_name;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FacilityLevel
     */
    ...
    {
        $newEntity = new TrustCare_Model_FacilityLevel($options);

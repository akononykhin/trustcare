...
class TrustCare_Model_Mapper_FrmCommunityMalariaType extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCommunityMalariaType $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCommunityMalariaType &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCommunityMalariaType $model)
    {
        $model->setObjectKeyInfo(
            array(
                'id' => $model->getId(),
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCommunityMalariaType $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCommunityMalariaType $model)
    {
    ...
    public function fetchAllForFrmCommunity($value)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCommunityMalariaType(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

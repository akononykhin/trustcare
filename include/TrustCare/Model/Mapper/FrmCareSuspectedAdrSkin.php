...
class TrustCare_Model_Mapper_FrmCareSuspectedAdrSkin extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCareSuspectedAdrSkin $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCareSuspectedAdrSkin &$model)
    {
        $data = array();
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCareSuspectedAdrSkin $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCareSuspectedAdrSkin $model)
    {
    ...
    public function fetchAllForFrmCare($id_frm_care)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCareSuspectedAdrSkin(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

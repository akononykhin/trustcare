...
class TrustCare_Model_Mapper_FrmCommunityHtcResult extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCommunityHtcResult $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCommunityHtcResult &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCommunityHtcResult $model)
    {
        $model->setObjectKeyInfo(
            array(
                'id' => $model->getId(),
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCommunityHtcResult $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCommunityHtcResult $model)
    {
    ...
    public function fetchAllForFrmCommunity($value)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCommunityHtcResult(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

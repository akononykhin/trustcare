...
class TrustCare_Model_FrmCareSuspectedAdrSkin extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCareSuspectedAdrSkin
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCareSuspectedAdrSkin($options);
    ...
    public static function replaceForFrmCare($id_frm_care, array $dictIds, array $options = null)
    {
        ...
        $model = new TrustCare_Model_FrmCareSuspectedAdrSkin($options);

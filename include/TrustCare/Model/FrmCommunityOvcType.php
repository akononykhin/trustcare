...
class TrustCare_Model_FrmCommunityOvcType extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityOvcType
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityOvcType($options);

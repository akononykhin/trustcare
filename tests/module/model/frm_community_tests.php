...
class TestOfFrmCommunity extends UnitTestCase {
    ...
    function testChangeParameters()
    {
        ...
        if(!is_null($model)) {
            ...
            $params['is_malaria_services'] = !$model->is_malaria_services;
    ...
    private function _compareObjectAndParams($model, $params, $checkTime = true) {
        ...
        $this->assertIdentical($model->is_malaria_services, !empty($params['is_malaria_services']) ? true : false, "Incorrect 'is_malaria_services': %s");

...
class TrustCare_Model_DbTable_ReportCommunityServices extends ZendX_Db_Table_Abstract
{
    protected $_name    = 'report_community_services';
    ...
    protected $_metadata = array (
                'id' => 
                    array (
                      'SCHEMA_NAME' => NULL,
                      'TABLE_NAME' => 'report_community_services',
                      'COLUMN_NAME' => 'id',
                      'COLUMN_POSITION' => 1,
                      'DATA_TYPE' => 'int',
                      'DEFAULT' => NULL,
    ...
    public function insert(array $data)
    {
        ...
        $data['id'] = $db->nextSequenceId('report_community_services_id_seq');

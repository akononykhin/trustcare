...
class TrustCare_Model_FrmCommunityReferredFrom extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityReferredFrom
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityReferredFrom($options);

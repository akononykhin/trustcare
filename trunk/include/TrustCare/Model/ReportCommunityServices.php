...
class TrustCare_Model_ReportCommunityServices extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_ReportCommunityServices
     */
    ...
    {
        $newEntity = new TrustCare_Model_ReportCommunityServices($options);

...
class TrustCare_Model_Mapper_FrmCommunityPalliativeCareType extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCommunityPalliativeCareType $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCommunityPalliativeCareType &$model)
    {
        $data = array();
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCommunityPalliativeCareType $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCommunityPalliativeCareType $model)
    {
    ...
    public function fetchAllForFrmCommunity($value)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCommunityPalliativeCareType(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

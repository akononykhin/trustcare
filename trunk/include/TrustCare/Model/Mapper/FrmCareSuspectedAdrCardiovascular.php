...
class TrustCare_Model_Mapper_FrmCareSuspectedAdrCardiovascular extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCareSuspectedAdrCardiovascular $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCareSuspectedAdrCardiovascular &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCareSuspectedAdrCardiovascular $model)
    {
        $model->setObjectKeyInfo(array('id' => $model->getId()));
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCareSuspectedAdrCardiovascular $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCareSuspectedAdrCardiovascular $model)
    {
    ...
    public function fetchAllForFrmCare($id_frm_care)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCareSuspectedAdrCardiovascular(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

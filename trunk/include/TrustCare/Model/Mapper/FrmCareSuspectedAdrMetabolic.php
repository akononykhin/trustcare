...
class TrustCare_Model_Mapper_FrmCareSuspectedAdrMetabolic extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCareSuspectedAdrMetabolic $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCareSuspectedAdrMetabolic &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCareSuspectedAdrMetabolic $model)
    {
        $model->setObjectKeyInfo(
            array(
                'id' => $model->getId(),
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCareSuspectedAdrMetabolic $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCareSuspectedAdrMetabolic $model)
    {
    ...
    public function fetchAllForFrmCare($id_frm_care)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCareSuspectedAdrMetabolic(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

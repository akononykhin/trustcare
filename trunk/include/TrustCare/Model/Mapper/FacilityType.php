...
class TrustCare_Model_Mapper_FacilityType extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FacilityType $model 
     * @return void
     */
    public function save(TrustCare_Model_FacilityType &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FacilityType $model)
    {
        $model->setObjectKeyInfo(array('id' => $model->getId()));
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FacilityType $model)
    {
    ...
    public function fetchAll(array $clauses = array())
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FacilityType(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

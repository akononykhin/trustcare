...
class TrustCare_Model_Mapper_FrmCareMedErrorInterventionOutcome extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCareMedErrorInterventionOutcome $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCareMedErrorInterventionOutcome &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCareMedErrorInterventionOutcome $model)
    {
        $model->setObjectKeyInfo(
            array(
                'id' => $model->getId(),
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCareMedErrorInterventionOutcome $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCareMedErrorInterventionOutcome $model)
    {
    ...
    public function fetchAllForFrmCare($id_frm_care)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCareMedErrorInterventionOutcome(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

...
class TrustCare_Model_Mapper_FrmCareAdhInterventionOutcome extends TrustCare_Model_Mapper_Abstract
{
    /**
     * @param  TrustCare_Model_FrmCareAdhInterventionOutcome $model 
     * @return void
     */
    public function save(TrustCare_Model_FrmCareAdhInterventionOutcome &$model)
    {
        $data = array();
    ...
    public function delete(TrustCare_Model_FrmCareAdhInterventionOutcome $model)
    {
        $model->setObjectKeyInfo(array('id' => $model->getId()));
    ...
    private function _fillModelForFind(TrustCare_Model_FrmCareAdhInterventionOutcome $model, $row)
    {
     ...
     * @return void
     */
    public function find($id, TrustCare_Model_FrmCareAdhInterventionOutcome $model)
    {
    ...
    public function fetchAllForFrmCare($id_frm_care)
    {
        ...
        foreach ($resultSet as $row) {
            $entry = new TrustCare_Model_FrmCareAdhInterventionOutcome(array('mapperOptions' => array('adapter' => $this->getDbAdapter())));

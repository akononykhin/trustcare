...
class TrustCare_Model_FrmCommunityReferredIn extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityReferredIn
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityReferredIn($options);

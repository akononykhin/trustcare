...
class TrustCare_Model_FrmCommunityHtcResult extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityHtcResult
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityHtcResult($options);

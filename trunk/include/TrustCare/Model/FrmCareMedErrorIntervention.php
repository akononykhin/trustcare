...
class TrustCare_Model_FrmCareMedErrorIntervention extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCareMedErrorIntervention
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCareMedErrorIntervention($options);

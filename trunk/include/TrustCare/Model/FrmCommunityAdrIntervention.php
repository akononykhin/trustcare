...
class TrustCare_Model_FrmCommunityAdrIntervention extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityAdrIntervention
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityAdrIntervention($options);

...
class TrustCare_Model_FrmCommunityPalliativeCareType extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityPalliativeCareType
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityPalliativeCareType($options);

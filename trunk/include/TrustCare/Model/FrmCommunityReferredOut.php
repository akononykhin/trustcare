...
class TrustCare_Model_FrmCommunityReferredOut extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityReferredOut
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityReferredOut($options);

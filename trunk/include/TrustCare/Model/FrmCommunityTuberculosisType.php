...
class TrustCare_Model_FrmCommunityTuberculosisType extends TrustCare_Model_Abstract
{
    protected $_id;
    ...
    /**
     * @param  int $value 
     * @return TrustCare_Model_FrmCommunityTuberculosisType
     */
    ...
    {
        $newEntity = new TrustCare_Model_FrmCommunityTuberculosisType($options);
